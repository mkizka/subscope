  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          `
            fixed z-50 flex flex-col bg-card bg-clip-padding text-sm shadow-lg
            transition-all duration-200 ease-in-out
            data-[side=bottom]:inset-x-0 data-[side=bottom]:bottom-0
            data-[side=bottom]:h-auto data-[side=bottom]:rounded-t-3xl
            data-[side=bottom]:border-t data-[side=bottom]:border-border/40
            ...
            data-[side=top]:h-auto data-[side=top]:rounded-b-3xl
