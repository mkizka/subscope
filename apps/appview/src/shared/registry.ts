...
export const createAppRegistry = (env: Env) =>
  createRegistry()
    ...
    .service("searchActorsTypeahead", ["searchActorsTypeaheadUseCase"], asClassArgs(SearchActorsTypeahead))
    ...
    .service("getRepostedBy", ["getRepostedByUseCase", "db"], asClassArgs(GetRepostedBy))
    ...
    .service("getSubscriptionStatus", ["getSubscriptionStatusUseCase"], asClassArgs(GetSubscriptionStatus))
    .service("subscribeServer", ["subscribeServerUseCase", "authVerifierMiddleware"], asClassArgs(SubscribeServer))
    .service("unsubscribeServer", ["unsubscribeServerUseCase"], asClassArgs(UnsubscribeServer))
