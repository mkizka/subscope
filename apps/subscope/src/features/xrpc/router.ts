...
import { wellKnownRouter } from "./presentation/routes/well-known.js";
import { XRPCRouter } from "./presentation/routes/xrpc.js";

const xrpcInjector = createInjector()
  // envs
...
export const xrpcRouter = xrpcInjector.resolve("xrpcRouter").create();
export { healthRouter, wellKnownRouter };
