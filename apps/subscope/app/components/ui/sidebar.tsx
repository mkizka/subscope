      ...
      >
        <div
          ...
          className="
            ...
            group-data-[variant=floating]:border-border/40
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          `
            ...
            justify-center rounded-lg p-0 text-sidebar-foreground
    ...
    <div
      ...
      className={cn(
        `
          ...
          justify-center rounded-4xl px-1 text-xs font-semibold
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          `
            ...
            rounded-xl px-2 text-sidebar-foreground ring-sidebar-ring
            outline-hidden
            group-data-[collapsible=icon]:hidden
            hover:bg-sidebar-accent hover:text-sidebar-accent-foreground
            focus-visible:ring-2
